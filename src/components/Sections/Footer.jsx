...
const Footer = () => {
    ...
    const scrollToTop = () => {
        window.scrollTo({top: 0, behaviours: "smooth"});
    };
    ...
    const AnimateGradientLine = () => (
        <div className='absolute top-0 left-0 w-full h-px overflow-hidden'>
            ...
            className={`h-px bg-gradient-to-r ${
                isDarkMode
                ? "from-transparent via-purple-700 to-transparent"
                : "from-transparent via-purple-800 to-transparent"
            }`}
        ...
        >
            ...
            >
                ...
                >
                  ...
                  className={`text-sm ${
                  isDarkMode
                  ? "text-gray-400" :"text-gray-600"} max-w-md mx-auto`}
                  >
                    Crafting digital experiences that connect developers and end users.
                    </motion.p>
     </motion.div>
                    ...
                    >
                      ...
                      >
                        ...
                        whileHover={{
                            ...
                            ? "0 10px 25px rgba(50, 130, 246, 0.15)"
                            : "0 10px 25px rgba(50, 130, 246, 0.1)"
                        }}
                        whileTap={{scale: 0.05}}
                        >
                            <ArrowUp size={16} />
