  ...
  return (
    ...
    >
        ...
        className={`rounded-2xl overflow-hidden border transition-all duration-500 ${
            isDarkMode
            ? "bg-gray-900/50 border-gray-800 hover:border-gray-700 hover:shadow-2xl hover:shadow-purple-700/10"
            : "bg-white/80 border-gray-200 hover:border-gray-300 hover:shadow-2xl hover:shadow-purple-700/10"
        } backdrop-blur-sm`}
        >
             {/**Project Image */}
             <div
             ...
             <div className='absolute top-4 right-4'>
                ...
                >
                    ...
                    className='bg-purple-700 hover:bg-purple-800 text-white px-4 py-2 rounded-full flex items-center space-x-2 text-sm font-medium transition-colors'    
                    >
                 ...
                 <div
                 className='p-6'>
                    <h3 className='text-xl font-medium mb-3 group-hover:text-purple-700 transition-colors'>
                        {project.title}
                    </h3>
